            ...
            <li class="nav-item">
              <div class="dropdown">
                ...
                <?php
                  ...
                  ?>
                  <a class="dropdown-item" href="<?= $router->generate('category', ['id' => $categoryId]) ?>"><?= $categoryName ?></a>
                  <?php
                    endforeach;
                  ?>
                </div>
            ...
            <li class="nav-item">
              <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                  ...
                  ?>
                  <a class="dropdown-item" href="<?= $router->generate('type', ['id' => $typeId]) ?>"><?= $typeName ?></a>
                  <?php
                    endforeach;
                  ?>
                </div>
            ...
            <li class="nav-item">
              <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                  ...
                  ?>
                  <a class="dropdown-item" href="<?= $router->generate('brand', ['id' => $brandId]) ?>"><?= $brandName; ?></a>
                  <?php
                    endforeach;
                  ?>
                </div>
